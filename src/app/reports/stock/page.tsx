          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">
                ...
                <th className="px-8 py-5 text-center print:hidden">Audit</th>
              </tr>
            </thead>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-8 py-5 text-center print:hidden">
                       <Link 
                         href={`/reports/stock/${item.id}/ledger`}
                         className="p-3 text-indigo-600 hover:bg-slate-100 rounded-xl inline-block transition-all"
                         title="Item Audit Ledger"
                       >
                         <History size={18} />
                       </Link>
                    </td>
